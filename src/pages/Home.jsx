    ...
    <div className=''>
      <div className=' p-4 mt-[2rem] mx-auto max-w-[1290px]'>
        <div className=' border-red-500'>
          ...
          {/* Product Grids */}
          <div className=' border-red-500 grid  grid-cols-5'>
            ...
            <div className='col-span-4 flex flex-col gap-4 border-black'>
              ...
              <div className=' grid grid-cols-3 gap-y-6 gap-x-3 border-black p-4'>
                {result.map((item, index) => {
                  return (
                    <>
                      <div className='col-span-1 border-black' key={index}>
                        <div className='w-[21vw] h-[26vw]'>
                          <img className='w-full h-full rounded-xl object-cover' src={item.img} alt="" />
                        </div>

                        <div className='mt-4 flex flex-col'>
                          <h1 className='font-semibold h-[2rem] overflow-hidden'>{item.title}</h1>
